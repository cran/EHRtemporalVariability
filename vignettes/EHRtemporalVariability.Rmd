...
```{r estimateIGTProjection, eval=TRUE}
...
```{r estimateIGTProjectionOutput, eval=TRUE}
class( igtProj )
```
...
```{r plotIGTprojectionTrajectory, eval=TRUE}
plotIGTProjection( 
    igtProjection   =  igtProjs[["diagcode1-phewascode"]],
    colorPalette    = "Spectral", 
    dimensions      = 2,
...
```{r temporalSubgroupsClustering, eval=TRUE}
